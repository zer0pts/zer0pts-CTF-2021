<template>
  <div class="my-4 mx-8">
    ...
    <div class="mt-4">
      ...
      <p class="ml-4">Welcome to zer0pts CTF 2021!</p>
      <p class="ml-4">zer0pts CTF is a jeopardy-style CTF.</p>
    ...
    <div class="mt-4">
      ...
      <p class="ml-4">
        Discord: <a href="https://discord.gg/2u47XhrhPg" target="_blank">https://discord.gg/2u47XhrhPg</a>.
      </p>
    </div>
    ...
    <div class="mt-4">
      ...
      <div class="ml-4">
        <ul class="list-disc list-inside">
          ...
          <li>The flag format is <code>zer0pts\{[\x20-\x7e]+\}</code>, unless specified otherwise.</li>
    ...
    <div class="mt-4">
      ...
      <p class="ml-4">Eight best teams will get one of these prizes:</p>
      <div class="ml-4">
        <ol>
          <li>$1337 + 75 XTZ</li>
          <li>$512 + 50 XTZ</li>
      ...
      <p class="ml-4">After the CTF is over, we'll contact the top 8 teams by email: <code>zer0ptsctf@gmail.com</code>.</p>
      <p class="ml-4">In order to claim one of the prizes, you'll have to submit your writeups for some of our challenges.</p>
    </div>

    <div class="mt-4">
      <h2 class="text-2xl">[ Sponsors ]</h2>
      <div class="sponsors ml-4">
        <a href="https://securitylab.github.com/" target="_blank">
          <p>GitHub Security Lab</p>
          <img src="../assets/GitHub.png" alt="GitHub Security Lab">
        </a>

        <a href="https://tezoscommons.org/" target="_blank">
          <p>Tezos Community</p>
          <img src="../assets/Tezos.png" alt="Tezos Community">
        </a>

        <a href="https://defenit.kr/" target="_blank">
          <p>Defenit</p>
          <img src="../assets/Defenit.png" alt="Defenit">
        </a>
      </div>
    </div>
